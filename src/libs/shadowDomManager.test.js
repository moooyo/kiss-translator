...
import ShadowDomManager, { toEmotionCacheKey } from "./shadowDomManager";

globalThis.IS_REACT_ACT_ENVIRONMENT = true;

// Emotion rejects characters outside [a-z-], which can silently prevent mounting.
// Keep application names with version suffixes safe for the shared manager.
