...
.kt-content-fab-menu { min-width: 210px; max-height: min(360px, calc(100vh - 92px)); display: flex; flex-direction: column-reverse; align-items: flex-end; gap: 8px; position: absolute; right: 0; bottom: 68px; overflow-y: auto; overscroll-behavior: contain; padding: 2px; }
