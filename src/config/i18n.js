...
export const I18N = {
  ...
  popup_extension_disabled: {
    zh: `简约翻译已暂停`,
    en: `KISS Translator is paused`,
    zh_TW: `簡約翻譯已暫停`,
    ja: `KISS Translator は一時停止中です`,
    ko: `KISS Translator가 일시 중지되었습니다`,
    tr: `KISS Translator duraklatıldı`,
  },
  popup_extension_disabled_description: {
    zh: `在设置中重新开启总开关后，当前页面会立即恢复翻译能力。`,
    en: `Turn the master switch back on in settings to resume translation on this page.`,
    zh_TW: `在設定中重新開啟總開關後，目前頁面會立即恢復翻譯功能。`,
    ja: `設定でマスタースイッチをオンにすると、このページの翻訳を再開できます。`,
    ko: `설정에서 마스터 스위치를 다시 켜면 이 페이지의 번역을 재개할 수 있습니다.`,
    tr: `Bu sayfada çeviriyi sürdürmek için ayarlardan ana anahtarı yeniden açın.`,
  },
